...
<body>
    ...
    <div style="text-align: center; margin-top: 20px;">
        ...
        <a href="{{ url('/cv') }}" class="button">CV</a>
        <a href="{{ url('/portofolio') }}" class="button">Portofolio</a>
        <a href="{{ url('/fact') }}" class="button">Fact</a>
        <a href="{{ url('/Media Sosial') }}" class="button">Media Sosial</a>
    </div>
